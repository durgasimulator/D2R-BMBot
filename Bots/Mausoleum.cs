...
public class Mausoleum : IBot
{
    ...
    public void DetectCurrentStep()
    {
        ...
        if ((Enums.Area)gameData.playerScan.levelNo == Enums.Area.Mausoleum) CurrentStep = 3;

        if ((Enums.Area)gameData.playerScan.levelNo == Enums.Area.Crypt)
        {
    ...
    public void RunScript()
    {
        ...
        else
        {
            if (CurrentStep == 0)
            {
                gameData.SetGameStatus("DOING MAUSOLEUM");
            ...
            {
                //####
                if (gameData.playerScan.levelNo == (int)Enums.Area.Mausoleum)
                {
                    CurrentStep++;
                    return;
                }
            ...
            if (CurrentStep == 3)
            {
                ...
                gameData.SetGameStatus("CLEARING MAUSOLEUM");

                if ((Enums.Area)gameData.battle.AreaIDFullyCleared != Enums.Area.Mausoleum)
                {
